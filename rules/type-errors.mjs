...
export default {
  ...
  // imported identifiers are read-only
  ...
  'no-new-native-constructor': ['error'], // no-new-symbol deprecation  // Symbol
  //'no-buffer-constructor': ['error'], // Buffer - buffer constructors are entirely deprecated
